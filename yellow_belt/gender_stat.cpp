...
void PrintStats(vector<Person> persons) {
    auto females_end = std::partition(persons.begin(), persons.end(), [](Person x){return x.gender == Gender::FEMALE;});
    auto employed_females_end = std::partition(persons.begin(), females_end, [](Person x){return x.is_employed;});
    auto employed_males_end = std::partition(females_end, persons.end(), [](Person x){return x.is_employed;});
